...
!                     JJS, Dec 24/2009
!=============================================================
subroutine pois_2(ut,vt,wt,pt,res,rest,rt,varstep,mpiid,communicator)

  use point_2
  use alloc_dns_2,only:idx,idy,idxx,idyy,phiy,dy,y,kaz,kaz2,kmod,ayp
  use ctesp_2
  use omp_lib
  use temporal_2
  implicit none
  ...
  call chp2x_2(res,rest,rt,mpiid,ny,comm)
  if (mpiid2.eq.0) then
     tm1 = MPI_WTIME()
  endif
...
!=============================================================
  ...
  call cosftx_2(res(2,mpvb),nx,mpvb,mpve,-1) 
  !$OMP END PARALLEL
!=============================================================
!=============================================================
  ...
  call chx2p_2(res,rest,rt,mpiid,ny,comm)
  ...
  do i = ib0,ie 
     ...
     do k = 0,nz2
        ...
        call soltriy_2(rest(0,1,i),rest(0,1,i),k,aypr)
     enddo
...
!/*                                                                   */
!/*********************************************************************/
subroutine soltriy_2(u,us,ii,a) 	!ii=column to be solved
  use ctesp_2
  implicit none
