...
!----------------------------------------------------------
  ...
  call chx2p_2(dudx_pencil,dudx_zy,dwdx,mpiid,ny+1)            !dudx_zy =d(u)dx in planes . dwdx==buffer
  !==============================================================================
...
!===============CORRELATIONS==================
#ifndef NOCORR
call compute_corr_2(coru,corv,corw,coruv,corp,corox,coroy,coroz,buf_cor,buf_corp,dwdx,dudx_zy,mpiid)
#endif
...
subroutine compute_corr_2(cor1,cor2,cor3,cor4,cor5,cor6,cor7,cor8,buf_cor,buf_corp,buf_change,buf_cor2,mpiid)
  ...
  do ii=1,lxcorr
     do j=1,7       
        call chp2x_2(buf_corp(1,1,j,ii),buf_cor2(0,1,ib,j,ii),buf_change,mpiid,ncorr)       
     enddo
