...
subroutine statsp_2(u_x,v,w,p, &
  ...
  do i=ib,ie             
     ...
     call interpy_new_2(u_x(0,1,i) ,buf1,fd_iy ,0)   !buf1=(u_x)_y          
     call interpy_new_2(w(0,1,i)   ,buf2,fd_iy ,0)   !buf2=w_y 
     call interpy_new_2(dwdx(0,1,i),buf3,fd_iy ,0)   !buf3==dwdx_y!!  
     call interpy_new_2(dudx(0,1,i),buf4,fd_iy ,0)   !buf4==dudx_y!!  
     call interpy_new_2(p(0,1,i)   ,buf5,fd_iyp,1)   !buf5=p 
     !$OMP BARRIER
     call diffy_inplace_2(buf1    ,buf6,fd_dvdy)  !buf6=dudy (barrier cause, buf6=dwdx)
     ...
     call fourxz_2(buf1(0:nz2,jbf2:jef2),bphy3(1:nz+2,jbf2:jef2),1,ny,jbf2,jef2)!bphy3=[u_x]_y real
     !$OMP BARRIER  !(bphy3==buf4=bufuphy USED. U REAL)         
     call fourxz_2(buf2(0:nz2,jbf2:jef2),bphy1(1:nz+2,jbf2:jef2),1,ny,jbf2,jef2)!bphy1=w_y real
...
#ifndef NOCORR
  !===============CORRELATIONS==================
  call compute_corr_2(coru,corv,corw,coruv,corp,corox,coroy,coroz,coruw,corvw,&
...
subroutine compute_corr_2(cor1,cor2,cor3,cor4,cor5,cor6,cor7,cor8,cor9,cor10,&
...
!!!!!!!!!!!CHANGING CORRELATIONS BUFFERS TO PENCILS
  do ii=1,lxcorr
     ...
     call c_corr_2(cor1 (1,1,ii),buf_corp(1,1,1,ii),buf_corp(1,1,1,ii),ii,mpiid,0)!cor_u   
     call c_corr_2(cor2 (1,1,ii),buf_corp(1,1,2,ii),buf_corp(1,1,2,ii),ii,mpiid,0)!cor_v   
     call c_corr_2(cor3 (1,1,ii),buf_corp(1,1,3,ii),buf_corp(1,1,3,ii),ii,mpiid,0)!cor_w   
     call c_corr_2(cor4 (1,1,ii),buf_corp(1,1,1,ii),buf_corp(1,1,2,ii),ii,mpiid,0)!cor_uv   
     call c_corr_2(cor5 (1,1,ii),buf_corp(1,1,4,ii),buf_corp(1,1,4,ii),ii,mpiid,0)!cor_p   
     call c_corr_2(cor6 (1,1,ii),buf_corp(1,1,5,ii),buf_corp(1,1,5,ii),ii,mpiid,0)!cor_ox   
     call c_corr_2(cor7 (1,1,ii),buf_corp(1,1,6,ii),buf_corp(1,1,6,ii),ii,mpiid,0)!cor_oy   
     call c_corr_2(cor8 (1,1,ii),buf_corp(1,1,7,ii),buf_corp(1,1,7,ii),ii,mpiid,0)!cor_oz   
     call c_corr_2(cor9 (1,1,ii),buf_corp(1,1,1,ii),buf_corp(1,1,3,ii),ii,mpiid,1)!cor_uw   
     call c_corr_2(cor10(1,1,ii),buf_corp(1,1,2,ii),buf_corp(1,1,3,ii),ii,mpiid,1)!cor_vw   
  enddo
...
subroutine c_corr_2(cor,buffer1,buffer2,j,rank,tipo)
