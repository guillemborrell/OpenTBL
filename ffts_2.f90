...
subroutine fourxz_2(fou,phys,iopt,jee,jbf,jef)   
  use ctesp_2
  use temporal_2
  use point_2
  use fourthings_2
...
end module cosfthings_2


subroutine cosfti_2(n)
  use cosfthings_2
  implicit none
  include "fftw3.f"
...
subroutine cosftx_2(c,isa,mb,me,iopt)
...
subroutine pointersfft_2(mpiid)
use point_2
use ctesp_2
use omp_lib
implicit none
