...
#define MAXCHARLEN 250
  ...
  subroutine escribezy_2(u,v,w,p,dt,mpiid)
    !----------------------------------------------------------------------*
  ...
  subroutine escrst_2(ax,ay,az,cfl,tiempo,re,x,y,mpiid,ical)
    use names_2
    use statistics_2
    use point_2
    use ctesp_2
   ...
   nbud=27
    ...
    call escr_corr_2(coru,corv,coruv,corw,corp,corox,coroy,coroz,mpiid)  
...
subroutine escr_corr_2(c1,c2,c3,c4,c5,c6,c7,c8,rank)
