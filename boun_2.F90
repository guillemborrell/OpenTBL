...
subroutine boun_2(ut,vt,wt)

  use alloc_dns_2,only:inby,ccon,y,idx,x,re,rkc,rkd,idy,dx,dy,delx,vmagic
  use ctesp_2
  use point_2
  use omp_lib
...
subroutine outflow_correction_2(ut,vt,rhsupat,communicator)
  use alloc_dns_2,only:inby,ccon,y,idx,x,re,rkc,rkd,idy,dx,dy,delx
  use ctesp_2
  use point_2
  use omp_lib
  implicit none
...
end subroutine outflow_correction_2
...
subroutine magicnumber_2(mpiid)
use alloc_dns_2,only: re,pi,ax,vmagic
use genmod_2,only:rthin
use ctesp_2
implicit none
